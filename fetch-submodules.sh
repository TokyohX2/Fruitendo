...
echo "Fetching Fruitendo's submodules..."
...
fetch_git "https://github.com/libretro/Fruitendo-assets.git" "media/assets"
fetch_git "https://github.com/libretro/Fruitendo-joypad-autoconfig.git" "media/autoconfig"
