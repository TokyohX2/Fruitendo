...
cd ../pkg/msvc/
devenv /clean Release_LTCG Fruitendo-Xbox1.sln
devenv /build Release_LTCG Fruitendo-Xbox1.sln
copy Fruitendo-Xbox1\Release_LTCG\Fruitendo.xbe Fruitendo-Xbox1\%1.xbe
del Fruitendo-Xbox1\Release_LTCG\Fruitendo.xbe
del Fruitendo-Xbox1\Release_LTCG\libretro_xdk1.lib
exit
