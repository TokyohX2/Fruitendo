      ...
      void *args, void *params_data)
{
   ...
   retro_main_log_file_init("/dev_hdd0/game/"
      EMULATOR_CONTENT_DIR "/USRDIR/Fruitendo-log.txt", false);
#endif
#elif defined(__PSL1GHT__)
#ifdef HAVE_FILE_LOGGER
   retro_main_log_file_init("/dev_hdd0/game/"
      EMULATOR_CONTENT_DIR "/USRDIR/Fruitendo-log-salamander.txt", false);
#endif
#endif
...
static void frontend_ps3_init(void *data)
{
   ...
   screenshot_param.photo_title = "Fruitendo PS3";
   screenshot_param.game_title = "Fruitendo PS3";
